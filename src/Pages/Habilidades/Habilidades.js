...
class Habilidades extends Component {
	render() {
		return (
            ...
            <SkillChart ><h2 style={{ width: "45%" }}>JavaScript</h2></SkillChart>
            <SkillChart ><h2 style={{ width: "50%" }}>jQuery</h2></SkillChart>
            <SkillChart ><h2 style={{ width: "20%" }}>React</h2></SkillChart>
            <SkillChart ><h2 style={{ width: "35%" }}>Sass</h2></SkillChart>
            <SkillChart ><h2 style={{ width: "40%" }}>Git</h2></SkillChart>
            <SkillChart ><h2 style={{ width: "35%" }}>WordPress</h2></SkillChart>
				</div>
			</main>	
		);
    }
